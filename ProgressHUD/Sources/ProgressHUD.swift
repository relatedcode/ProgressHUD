...
public extension ProgressHUD {
  ...
  class var allowInteraction: Bool {
    get { shared.allowInteraction }
    set { shared.allowInteraction = newValue }
  }
...
public extension ProgressHUD {
  ...
  // MARK: -
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func show(_ status: String? = nil, icon: AlertIcon, interaction: Bool = allowInteraction) {
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func show(_ status: String? = nil, icon animatedIcon: AnimatedIcon, interaction: Bool = allowInteraction) {
  ...
  // MARK: -
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func showSuccess(_ status: String? = nil, image: UIImage? = nil, interaction: Bool = allowInteraction) {
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func showError(_ status: String? = nil, image: UIImage? = nil, interaction: Bool = allowInteraction) {
  ...
  // MARK: -
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func showSucceed(_ status: String? = nil, interaction: Bool = allowInteraction) {
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func showFailed(_ status: String? = nil, interaction: Bool = allowInteraction) {
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func showAdded(_ status: String? = nil, interaction: Bool = allowInteraction) {
  ...
  // MARK: -
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func showProgress(_ progress: CGFloat, interaction: Bool = allowInteraction) {
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------
  class func showProgress(_ status: String?, _ progress: CGFloat, interaction: Bool = allowInteraction) {
...
public class ProgressHUD: UIView {
  ...
  private var allowInteraction: Bool = true
