...
class ViewController: UITableViewController {
	...
	override func viewDidLoad() {
		...
		actions.append("Progress - Percentage")
		actions.append("Progress - Short text")
		actions.append("Progress - Longer text")
		actions.append("Success - No text")
		actions.append("Success - Short text")
		actions.append("Error - No text")
		actions.append("Error - Short text")
...
extension ViewController {
	...
	override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
		...
		if (section == 2) { return actions.count	}
		if (section == 3) { return icons1.count		}
		if (section == 4) { return icons2.count		}
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		if (indexPath.section == 2) { return self.tableView(tableView, cellWithText: actions[indexPath.row])	}
		if (indexPath.section == 3) { return self.tableView(tableView, cellWithText: icons1[indexPath.row])		}
		if (indexPath.section == 4) { return self.tableView(tableView, cellWithText: icons2[indexPath.row])		}
	...
	override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
		...
		if (section == 3) { return "Icons - Animated"	}
		if (section == 4) { return "Icons - Static"		}
...
extension ViewController {
	...
	override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		...
		if (indexPath.section == 1)	{
			...
			if (indexPath.row == 2)	 { ProgressHUD.animationType = .lineScalling				}
		...
		if (indexPath.section == 2) {
			...
			if (indexPath.row == 3) { ProgressHUD.showSuccess()				}
			if (indexPath.row == 4) { ProgressHUD.showSuccess(textSuccess)	}
			if (indexPath.row == 5) { ProgressHUD.showError()				}
			if (indexPath.row == 6) { ProgressHUD.showError(textError)		}
		}
